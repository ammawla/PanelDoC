...
### Authors: Alex S. Nord, Alex M. Mawla Copyright 2011-2015
...
experiment.directory = "{Path to Parent Dir}/CNV_Tutorial",

# directory where platform data is stored
platform.directory = "{Path to Parent Dir}/CNV_Tutorial/Platform",

# directory where genome information is stored
genome.directory = "{Path to UCSC Dir}/UCSC/hg19/sequence", 

# directory where gene annotation information is stored
annotation.directory = "{Path to UCSC Dir}/UCSC/hg19/annotation",

### Set input data filenames (must match expected format)
# file with sample information for processing batch in csv format
sample.filename = "{Path to Parent Dir}/CNV_Tutorial/Input/SampleInformation.csv",

# file with information for bait probes in bed format
bait.filename = "{Path to Parent Dir}/CNV_Tutorial/Input/baitcoverage.bed",

# file with data on how genomic coverage data is stored (typically chromosomes)
partition.filename = "{Path to Parent Dir}/CNV_Tutorial/Input/Platform_partitionInformation.csv",

# file with all known CNVs for normalization purposes (including large known CNVs should improve normalization)
knowncnvs.filename = "{Path to Parent Dir}/CNV_Tutorial/Input/knowncnvs.csv",
 
# refesq file from UCSC used for plotting (should be in annotation.directory)
gene.filename = "{Path to UCSC Dir}/UCSC/hg19/annotation/refFlat.txt",
 
# source file for functions 
source.filename = "{Path to Parent Dir}/CNV_Tutorial/Scripts/DoC_functions.R",
